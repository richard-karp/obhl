  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-3">
        {/*
          `!editor` as well as `saving`: `immediatelyRender: false` and lazy loading defer the mount, and
          inside that window `onSave` returns silently, so a fast click did nothing.
        */}
